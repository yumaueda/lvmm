...
int main() {
    ...
    r = vm->initRAM("console=ttyS0 earlyprintk=serial noapic noacpi nowatchdog nmi_watchdog=0 debug apic=debug show_lapic=all mitigations=off lapic rdinit=/init init=/init");
    if (r) {
